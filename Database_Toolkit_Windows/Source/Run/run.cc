...
int main ()
{
	...
	do
	{
		...
		if(selection == 1)
		{
			a = system("cd ./.Binaries && dbMaker && cd ..");
			
		}
		else if(selection == 2)
		{
			b = system("cd ./.Binaries && mergeUniques && cd ..");
			if(!b)
			{
				system("cls");
			...
			{
				cout << "Unknown error has occured. Please ensure your files are in the 'Merge_Database' directory and you have followed instructions correctly." << endl;
			}
		}
